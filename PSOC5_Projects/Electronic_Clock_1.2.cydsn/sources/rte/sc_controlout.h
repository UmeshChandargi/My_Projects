...
/**
 *  file    SC_CONTROLOUT_signal.h
 *
 *  brief   signal base class for signal sc_controlout
 *
...
#ifndef SC_CONTROLOUT_SIGNAL_H_INCLUDED
#define SC_CONTROLOUT_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_CONTROLOUT_driverIn_t)(SC_CONTROLOUT_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_CONTROLOUT_driverOut_t)( const SC_CONTROLOUT_data_t * const);
...
/**
 * Instances of the struct SC_CONTROLOUT_cfg_t represent the signal object configuration.
 */
struct SC_CONTROLOUT_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_CONTROLOUT_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_CONTROLOUT_driverOut_t const outDriver;
...
typedef const struct SC_CONTROLOUT_cfg_s SC_CONTROLOUT_cfg_t;
...
/**
 * Instances of the struct SC_CONTROLOUT_t represent the signal objects.
 * A signal object contains the current application value 'value' as well as relevant meta data.
 */
struct SC_CONTROLOUT_s
{                                                                                                                      
     ...
     */
	const SC_CONTROLOUT_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_CONTROLOUT_s SC_CONTROLOUT_t;
 ...
 *
 * @param  SC_CONTROLOUT_t * const signal: Pointer to the signal object which will be initialised
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONTROLOUT_init( SC_CONTROLOUT_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_CONTROLOUT_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_CONTROLOUT_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_CONTROLOUT_getStatus( const SC_CONTROLOUT_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_CONTROLOUT_setStatus( SC_CONTROLOUT_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_CONTROLOUT_getAge( const SC_CONTROLOUT_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_CONTROLOUT_incAge(  SC_CONTROLOUT_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_CONTROLOUT_t * const signal: Pointer to the signal object
 * @return sc_controlout_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_CONTROLOUT_data_t* RTE_SC_CONTROLOUT_getPtr( SC_CONTROLOUT_t * const signal )
{               
 ...
 *
 * @param  SC_CONTROLOUT_t * const signal: Pointer to the signal object
 * @return sc_controlout_data_t: current value of the application data buffer
 *
 **/
inline SC_CONTROLOUT_data_t RTE_SC_CONTROLOUT_get( const SC_CONTROLOUT_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_CONTROLOUT_t * const signal: Pointer to the signal object
 * @param  SC_CONTROLOUT_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONTROLOUT_getThreadSafe( const SC_CONTROLOUT_t * const signal, SC_CONTROLOUT_data_t * const data )
{    
 ...
 *
 * @param  SC_CONTROLOUT_t * const signal: Pointer to the signal object
 * @param  sc_controlout_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONTROLOUT_set(SC_CONTROLOUT_t * const signal, const SC_CONTROLOUT_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_CONTROLOUT_pullPort( SC_CONTROLOUT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_CONTROLOUT_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_CONTROLOUT_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_CONTROLOUT_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_CONTROLOUT_pushPort( const SC_CONTROLOUT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
