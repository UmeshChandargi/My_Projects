...
/**
 *  file    SC_BUTTONEVENT_signal.h
 *
 *  brief   signal base class for signal sc_buttonevent
 *
...
#ifndef SC_BUTTONEVENT_SIGNAL_H_INCLUDED
#define SC_BUTTONEVENT_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_BUTTONEVENT_driverIn_t)(SC_BUTTONEVENT_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_BUTTONEVENT_driverOut_t)( const SC_BUTTONEVENT_data_t * const);
...
/**
 * Instances of the struct SC_BUTTONEVENT_cfg_t represent the signal object configuration.
 */
struct SC_BUTTONEVENT_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_BUTTONEVENT_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_BUTTONEVENT_driverOut_t const outDriver;
...
typedef const struct SC_BUTTONEVENT_cfg_s SC_BUTTONEVENT_cfg_t;
...
{                                                                                                                      
     ...
     */
	const SC_BUTTONEVENT_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_BUTTONEVENT_s SC_BUTTONEVENT_t;
 ...
 *
 * @param  SC_BUTTONEVENT_t * const signal: Pointer to the signal object which will be initialised
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_BUTTONEVENT_init( SC_BUTTONEVENT_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_BUTTONEVENT_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_BUTTONEVENT_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_BUTTONEVENT_getStatus( const SC_BUTTONEVENT_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_BUTTONEVENT_setStatus( SC_BUTTONEVENT_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_BUTTONEVENT_getAge( const SC_BUTTONEVENT_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_BUTTONEVENT_incAge(  SC_BUTTONEVENT_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_BUTTONEVENT_t * const signal: Pointer to the signal object
 * @return sc_buttonevent_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_BUTTONEVENT_data_t* RTE_SC_BUTTONEVENT_getPtr( SC_BUTTONEVENT_t * const signal )
{               
 ...
 *
 * @param  SC_BUTTONEVENT_t * const signal: Pointer to the signal object
 * @return sc_buttonevent_data_t: current value of the application data buffer
 *
 **/
inline SC_BUTTONEVENT_data_t RTE_SC_BUTTONEVENT_get( const SC_BUTTONEVENT_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_BUTTONEVENT_t * const signal: Pointer to the signal object
 * @param  SC_BUTTONEVENT_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_BUTTONEVENT_getThreadSafe( const SC_BUTTONEVENT_t * const signal, SC_BUTTONEVENT_data_t * const data )
{    
 ...
 *
 * @param  SC_BUTTONEVENT_t * const signal: Pointer to the signal object
 * @param  sc_buttonevent_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_BUTTONEVENT_set(SC_BUTTONEVENT_t * const signal, const SC_BUTTONEVENT_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_BUTTONEVENT_pullPort( SC_BUTTONEVENT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_BUTTONEVENT_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_BUTTONEVENT_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_BUTTONEVENT_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_BUTTONEVENT_pushPort( const SC_BUTTONEVENT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
