 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (tsk_hmi) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 3))
    #define TASK_4_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_realtime) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_hmi*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_realtime*/
        #endif
        #ifdef TASK_5_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,&EE_oo_thread_stub      /* thread tsk_hmi */
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_realtime */
    #endif
    #if EE_MAX_TASK > 4
