 ...
 **************************************************************************/
    ...
    #define TASK_2_STACK_SIZE 2000/4 // size = 2000 bytes
    ...
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_fader) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_fader*/
        #endif
        #ifdef TASK_6_STACK_SIZE
