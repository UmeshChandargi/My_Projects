 ...
 *
 **/
inline RC_t RTE_SC_PWM_init( SC_PWM_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_PWM_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_PWM_t * const signal: Pointer to the signal object
 * @return sc_pwm_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_PWM_data_t* RTE_SC_PWM_getPtr( SC_PWM_t * const signal )
{               
