 ...
 *
 * description: specific task for age increment  
 * events: 
 * mode: Cyclic
 * name: tsk_system
 * shortname: system
...
const RTE_cyclicTable_t RTE_cyclicActivationTable_tsk_system[] = {
	{ SYSTEM_incAge_run, 1 },	//Runnable for incrementing age of all signals. This is done for debugging and diagnosis of the signals
};
